    ...
    <div className="w-full" {...getRootProps()}>
      <motion.div
        ...
        <input
          ...
          type="file"
          onChange={(e) => handleFileChange(Array.from(e.target.files || []).slice(0, 1))} // Only accept one file from the input
          className="hidden"
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p
            ...
            Drag or drop your receipt here or click to upload
          </p>
          <div className="relative w-full mt-10 max-w-xl mx-auto">
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  "relative group-hover/file:shadow-2xl z-40 bg-white border dark:bg-neutral-900 flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md",
